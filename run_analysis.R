...
# unzip files into working directory (already set)
...
# Add in appropriate descriptive labels to the column variables in the merged dataset using the created 'features' vector.  
# Add in descriptive column labels to the activity and subject tables.
...
# Create a tidy data set where the average for each of the variables has been calculated for each activity and 
# subject combination and shown on a single row.
